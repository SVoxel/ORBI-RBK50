...
ifeq ($(OPENWRT_BUILD_TYPE),DNI_BUILD)
	$(call PatchDir,$(PKG_BUILD_DIR),$(DNI_PATCH_DIR),)
endif
...
ifeq ($(OPENWRT_BUILD_TYPE),DNI_BUILD)
PATCH_DIR_DNI ?= ./patches_dni$(if $(wildcard ./patches_dni-$(KERNEL_PATCHVER)),-$(KERNEL_PATCHVER))
PATCH_DIR_DNI_EXT ?= ../../../dni_home/kernel/patches_dni
define Kernel/Patch/Default
	rm -rf $(PKG_BUILD_DIR)/patches; mkdir -p $(PKG_BUILD_DIR)/patches
	$(call PatchDir,$(PKG_BUILD_DIR),$(PATCH_DIR_DNI),platform_dni/)
	$(call PatchDir,$(PKG_BUILD_DIR),$(PATCH_DIR_DNI_EXT),platform_dni_ext/)
endef
else
define Kernel/Patch/Default
	rm -rf $(PKG_BUILD_DIR)/patches; mkdir -p $(PKG_BUILD_DIR)/patches
