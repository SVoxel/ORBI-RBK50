...
#define USB_SMB_NAME	"NETGEAR ORBI RBK50"
...
static void add_smbd_global(FILE *fp)
{
	...
	fprintf(fp, "  bind interfaces only = yes\n"
			...
			"  socket options = IPTOS_LOWDELAY TCP_NODELAY SO_KEEPALIVE SO_RCVBUF=131072 SO_SNDBUF=131072 SO_RCVBUF=131072 SO_SNDBUF=131072\n"
			"\n");
}
