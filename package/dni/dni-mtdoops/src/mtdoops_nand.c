...
static int reboot_reason_read_nand(struct file *file, char __user *buf, size_t count, loff_t *ppos)
{
...
static int reboot_reason_write_nand(struct file *file, const char __user *buf, size_t count, loff_t *ppos)
{
...
static const struct file_operations proc_reboot_reason_operations = {
	.read       = reboot_reason_read_nand,
	.write      = reboot_reason_write_nand,
};
