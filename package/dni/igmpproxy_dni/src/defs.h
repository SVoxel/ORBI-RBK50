...
#define   SUPPURT_MCAST_TO_UNICAST 0
...
#define INTERVAL_QUERY_RESPONSE  20
...
//#define LAN_IF	DGC_IF_LAN_IFNAME
//#define WAN_IF	DGC_IF_WAN_IFNAME
//#define PPP_IF	DGC_IF_PPP_IFNAME
char lan_ifname[32];
char wan_ifname[32];
char ppp_ifname[32];
char wan_phyname[32];
