...
#include <asm/errno.h>
#include "hw29765257p0p128p256p3x3p4x4_board_param.h"
#include "hw29765257p0p128p256p3x3p4x4.h"
...
int checkboard(void)
{
	printf("U-boot 2012.07 dni1 V0.1 for DNI HW ID: 29765257 NOR flash 0MB; NAND flash 128MB; RAM 256MB; 1st Radio 3x3; 2nd Radio 4x4\n");
	return 0;
}
