...
#define PLL_CONFIG_VAL_F		(PLL_FLASH_ADDR + CONFIG_SYS_FLASH_SECTOR_SIZE - 0x20)
#else
#define PLL_CONFIG_VAL_F		(PLL_FLASH_ADDR + CONFIG_SYS_FLASH_SECTOR_SIZE - 0x10)
#endif
#define PLL_MAGIC  			 0xaabbccdd

#ifndef CONFIG_WASP_SUPPORT
#if (CONFIG_SYS_PLL_FREQ == CONFIG_SYS_PLL_400_400_200)
...
#elif (CONFIG_SYS_PLL_FREQ == CONFIG_SYS_PLL_400_400_100)
...
#elif (CONFIG_SYS_PLL_FREQ == CONFIG_SYS_PLL_360_360_180)
...
#elif (CONFIG_SYS_PLL_FREQ == CONFIG_SYS_PLL_340_340_170)
...
#elif (CONFIG_SYS_PLL_FREQ == CONFIG_SYS_PLL_320_320_160)
...
#elif (CONFIG_SYS_PLL_FREQ == CONFIG_SYS_PLL_320_320_80)
...
#elif (CONFIG_SYS_PLL_FREQ == CONFIG_SYS_PLL_300_300_75)
...
#elif (CONFIG_SYS_PLL_FREQ == CONFIG_SYS_PLL_200_200_100)
...
#if (CONFIG_SYS_AR7241_PLL_FREQ == CONFIG_SYS_PLL_400_200_200)
...
#elif (CONFIG_SYS_AR7241_PLL_FREQ == CONFIG_SYS_PLL_280_280_130)
...
#elif (CONFIG_SYS_AR7241_PLL_FREQ == CONFIG_SYS_PLL_260_260_130)
...
#define CONFIG_SYS_934X_SDRAM_CONFIG_VAL	0x7fbe8cd0
#define CONFIG_SYS_934X_SDRAM_MODE_VAL_INIT	0x133
#define CONFIG_SYS_934X_SDRAM_MODE_VAL		0x33
#define CONFIG_SYS_934X_SDRAM_CONFIG2_VAL	0x959f66a8
#define CONFIG_SYS_934X_SDRAM_TAP_VAL		0x1f1f

#define CONFIG_SYS_934X_DDR1_CONFIG_VAL	0xc7d48cd0
#define CONFIG_SYS_934X_DDR1_MODE_VAL_INIT	0x133
#define CONFIG_SYS_934X_DDR1_EXT_MODE_VAL	0x0
#define CONFIG_SYS_934X_DDR1_MODE_VAL		0x33
#define CONFIG_SYS_934X_DDR1_CONFIG2_VAL	0x9dd0e6a8

#if (CONFIG_SYS_PLL_FREQ == CONFIG_SYS_PLL_500_500_250)
#define CONFIG_SYS_934X_DDR2_CONFIG_VAL	0xcfbc8cd0
#define CONFIG_SYS_934X_DDR2_MODE_VAL_INIT	0x143
#define CONFIG_SYS_934X_DDR2_EXT_MODE_VAL	0x402
#define CONFIG_SYS_934X_DDR2_MODE_VAL		0x43
#define CONFIG_SYS_934X_DDR2_CONFIG2_VAL	0xa5d0e6a8
#define CONFIG_SYS_934X_DDR2_EN_TWL_VAL	0x1659
#define CONFIG_SYS_934X_DDR2_TAP_VAL		0
#elif (CONFIG_SYS_PLL_FREQ == CONFIG_SYS_PLL_650_600_300) || \
      (CONFIG_SYS_PLL_FREQ == CONFIG_SYS_PLL_600_600_300) || \
      (CONFIG_SYS_PLL_FREQ == CONFIG_SYS_PLL_600_550_275) || \
      (CONFIG_SYS_PLL_FREQ == CONFIG_SYS_PLL_600_575_287)

#define CONFIG_SYS_934X_DDR2_CONFIG_VAL	0xcfd48cd0
#define CONFIG_SYS_934X_DDR2_MODE_VAL_INIT	0x143
#define CONFIG_SYS_934X_DDR2_EXT_MODE_VAL	0x402
#define CONFIG_SYS_934X_DDR2_MODE_VAL		0x43
#define CONFIG_SYS_934X_DDR2_CONFIG2_VAL	0xa1d0e6a8
#define CONFIG_SYS_934X_DDR2_EN_TWL_VAL	0x1659
#define CONFIG_SYS_934X_DDR2_TAP_VAL		0x5
#else
#define CONFIG_SYS_934X_DDR2_CONFIG_VAL	0x7fd48cd0
#define CONFIG_SYS_934X_DDR2_MODE_VAL_INIT	0x133
#define CONFIG_SYS_934X_DDR2_EXT_MODE_VAL	0x402
#define CONFIG_SYS_934X_DDR2_MODE_VAL		0x33
#define CONFIG_SYS_934X_DDR2_CONFIG2_VAL	0x99d0e6a8
#define CONFIG_SYS_934X_DDR2_EN_TWL_VAL	0xe59
#define CONFIG_SYS_934X_DDR2_TAP_VAL		0x10012
#endif

#define CONFIG_SYS_934X_DDR1_TAP_VAL		0x14
#endif	/* CONFIG_WASP */
